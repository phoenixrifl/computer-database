...
public class Ui {
	...
	public static int demande() {
		...
		System.out.println("Supprimer une companie, tapez 7");
		System.out.println("Quitter, taper 8");
	...
	public static int demandeIdCompany() {
		int input;
		Scanner sc = new Scanner(System.in);
		System.out.println("Donnez l'id de la companie");
		input = sc.nextInt();
